...
import (
	...
	"github.com/frosttlink/gobid/internal/store/pgstore"
...
func NewProuctService(pool *pgxpool.Pool) ProductService {
...
func (ps *ProductService) CreateProduct(
	...
	id, err := ps.queries.CreateProdutct(ctx, pgstore.CreateProdutctParams{
		SellerID:    sellerId,
